...
clear all
close all
% We are going to interpolate the Runge Function on [-1 , 1] using various
% points and methods: equally spaced points and chebyshev nodes using
% standard polynomial interpolation, as well as the cubic spline to compare
...
title('Interpolations of the Runge Function')
figure
plot(e, v(e) -  R(e), 'r', e, vt(e) - R(e), 'g', e, yy - R(e) , 'c')
ylim([-.02 , .02])
legend('equally spaced nodes error', 'cheby points error' , 'spline error')
title('error using various interpolation points and methods')